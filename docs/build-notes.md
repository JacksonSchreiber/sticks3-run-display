...
| File | What | Print |
|---|---|---|
| `stl/sleeve_frame.stl` | lug frame, cast into the sleeve's back; horns turn down toward the wrist | **PETG**, as exported, **supports on (build plate only)** under the horn tips, 4 walls, 100% infill |
