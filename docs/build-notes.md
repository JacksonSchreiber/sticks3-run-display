...
| File | What | Print |
|---|---|---|
| `stl/sleeve_frame.stl` | lug frame, cast into the sleeve's back; flat top, curved underside that thickens toward the ends, horns at the ends | **PETG**, as exported (flat face down), **no supports**, 4 walls, 100% infill |
