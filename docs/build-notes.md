...
A silicone sleeve (same pocket as the band, no straps) with a thin PETG lug frame cast into its back wall, so a standard 22 mm strap attaches with spring bars. Built: see "Sleeve parts" below. Thickness 16.6 mm, same as the band; lug gap 21.4 mm; bar 2 mm out from the end wall; the back is flat under the Stick and from 21 mm out curves down on an 18 mm radius, so the ends and horns follow the wrist (0.65 mm down at the sleeve end, 1.9 mm at the horn tips); 60 mm tip to tip.
